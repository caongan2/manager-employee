...
<div class="d-lg-flex half">
    <div class="bg order-1 order-md-2" style="background-image: url('form_login/images/img.jpg');"></div>
                ...
                <div class="col-md-7">
                    ...
                    <form action="home.php" method="post">
                        <div class="form-group first">
                            <label for="username">CodegymID</label>
                        ...
                        <div class="social-login">
                            <a href="home.php" class="facebook btn d-flex justify-content-center align-items-center">
